...
function getTotalBoxes(shipment: Shipment): number {
  const value = Number(shipment.totalBox);
...
function getBoxLabel(
  ...
  return `Box ${boxIndex + 1} / ${getTotalBoxes(shipment)}`;
}
...
export default function VendorShipmentsPage() {
  ...
  function printBill(
    ...
    setPrintMode("bill");
    // Wait for React + print styles to render.
    ...
    <>
      ...
      <style jsx global>{`
        ...
        @media print {
          ...
          body.print-bill #print-bill,
          body.print-bill #print-bill *,
          body.print-customer #print-customer,
          body.print-customer #print-customer * {
          ...
          body.print-bill #print-bill .print-page,
          body.print-customer #print-customer .print-page {
            width: 148mm !important;
          ...
          body.print-bill #print-bill .print-page:last-child,
          body.print-customer #print-customer .print-page:last-child {
            page-break-after: auto !important;
            break-after: auto !important;
          }

          body.print-bill #print-bill .qr-block,
          body.print-customer #print-customer .qr-block {
            page-break-inside: avoid !important;
            break-inside: avoid !important;
          }
        }
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-5 py-4">
                              ...
                              <span className="inline-flex min-w-[58px] items-center justify-center rounded-lg border border-[#dfe3e8] bg-[#f8fafc] px-2.5 py-1.5 text-xs font-black text-[#0b1729]">

                                {getBoxLabel(shipment, 0)}
      ...
      {printShipment &&
        printMode === "bill" && (
          <div id="print-bill" className="mx-auto w-full text-black">
            {Array.from(
              { length: getTotalBoxes(printShipment) },
              (_, boxIndex) => {
                const totalBoxes = getTotalBoxes(printShipment);

                return (
                  <div
                    key={`${printShipment.id}-bill-${boxIndex + 1}`}
                    className="print-page w-full text-black"
                  >
                    <div className="flex items-start justify-between gap-4 border-b-2 border-black pb-2">
                      <div>
                        ...
                        <p className="mt-0.5 text-[7px] font-bold uppercase tracking-[0.14em] text-gray-500">
                          Vendor Bill / VAT Invoice
                        </p>
                      </div>
                      <div className="shrink-0 border-2 border-black px-3 py-1.5 text-center">
                        <p className="text-[7px] font-bold uppercase tracking-wider">Box</p>
                        <p className="text-[13px] font-black">
                          {boxIndex + 1} / {totalBoxes}
                        </p>
                      </div>
                    </div>

                    <div className="grid grid-cols-2 gap-3 border-b py-2.5">
                      <div>
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Vendor</p>
                        ...
                        {printShipment.vendor?.address && (
                          <p className="mt-0.5 text-[7px] leading-3 text-gray-600">
                            {printShipment.vendor.address}
                          </p>
                        )}
                      </div>
                      <div className="text-right">
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Bill Date</p>
                        <p className="mt-0.5 text-[8px] font-bold">{formatDate(printShipment.createdAt)}</p>
                        <p className="mt-1.5 text-[7px] font-bold uppercase tracking-wider text-gray-500">Tracking</p>
                        <p className="mt-0.5 break-all text-[8px] font-black">{printShipment.trackingNumber}</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-2 gap-3 border-b py-2.5">
                      <div>
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">VAT</p>
                        <p className="mt-0.5 text-[8px] font-bold">
                          {printShipment.vendor?.vatNumber ||
                            printShipment.vendor?.vat ||
                            printShipment.vatNumber ||
                            printShipment.vat ||
                            "—"}
                        </p>
                      </div>
                      <div className="text-right">
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">PAN</p>
                        <p className="mt-0.5 text-[8px] font-bold">
                          {printShipment.vendor?.panNumber ||
                            printShipment.vendor?.pan ||
                            printShipment.panNumber ||
                            printShipment.pan ||
                            "—"}
                        </p>
                      </div>
                    ...
                    <div className="border-b py-2.5">
                      <p className="mb-1.5 text-[7px] font-bold uppercase tracking-wider text-gray-500">Shipment Details</p>
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Customer</p>
                          <p className="mt-0.5 text-[9px] font-bold">{printShipment.receiverName}</p>
                          <p className="mt-0.5 text-[7px] text-gray-600">{printShipment.receiverPhone}</p>
                        </div>
                        <div className="text-right">
                          <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Package</p>
                          <p className="mt-0.5 text-[9px] font-black">{printShipment.packageType}</p>
                          <p className="mt-0.5 text-[7px] text-gray-600">{printShipment.weight} kg</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 border-b py-2.5">
                      <div>
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Payment</p>
                        <p className="mt-0.5 text-[9px] font-bold">{printShipment.paymentType}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">COD</p>
                        <p className="mt-0.5 text-[10px] font-black">
                          {printShipment.paymentType === "COD"
                            ? formatCurrency(printShipment.codAmount)
                            : "N/A"}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="border-b py-2.5">
                      <div className="flex items-center justify-between gap-3">
                        <span className="text-[7px] font-bold uppercase tracking-wider">Logistic / Delivery Charge</span>
                        <span className="text-[10px] font-black">
                          {formatCurrency(
                            Number(
                              printShipment.logisticCharge ??
                      ...
                      <div className="mt-1.5 flex items-center justify-between gap-3">
                        <span className="text-[7px] font-bold uppercase tracking-wider">Packing Charge</span>
                        <span className="text-[9px] font-bold">
                          {formatCurrency(Number(printShipment.packingCharge) || 0)}
                        </span>
                      </div>
                      <div className="mt-1.5 flex items-center justify-between gap-3 border-t border-dashed border-gray-300 pt-1.5">
                        <span className="text-[8px] font-black uppercase tracking-wider">Total Charge</span>
                    ...
                    <div className="qr-block flex flex-1 items-center justify-between gap-4 py-2.5">
                      <div>
                        <p className="text-[7px] font-black uppercase tracking-wider">Package QR</p>
                        <p className="mt-1 text-[7px] leading-3 text-gray-500">Scan to track this package.</p>
                        <p className="mt-1 break-all text-[7px] font-bold">{printShipment.trackingNumber}</p>
                        <p className="mt-2 inline-flex border border-black px-2 py-1 text-[8px] font-black uppercase">
                          {getBoxLabel(printShipment, boxIndex)}
                        </p>
                      </div>
                      <div className="shrink-0 border-2 border-black p-1.5">
                        <QRCode
                          value={getTrackingUrl(printShipment.trackingNumber)}
                          size={82}
                        />
                      </div>
                    </div>
                    ...
                    <div className="border-t-2 border-black pt-2 text-center">
                      <p className="text-[7px] font-bold uppercase tracking-wider">{CARGO_COMPANY_NAME}</p>
                      <p className="mt-0.5 text-[6px] text-gray-500">Thank you for shipping with us.</p>
                    </div>
                  </div>
                );
              }
      ...
      {printShipment &&
        printMode === "customer" && (
          <div id="print-customer" className="mx-auto w-full text-black">
            {Array.from(
              { length: getTotalBoxes(printShipment) },
              (_, boxIndex) => {
                const totalBoxes = getTotalBoxes(printShipment);
                ...
                return (
                  <div
                    key={`${printShipment.id}-delivery-${boxIndex + 1}`}
                    className="print-page w-full text-black"
                  >
                    <div className="flex items-start justify-between gap-3 border-b-2 border-black pb-2">
                      <div>
                        <p className="text-[16px] font-black uppercase leading-tight">{CARGO_COMPANY_NAME}</p>
                        <p className="mt-0.5 text-[7px] font-bold uppercase tracking-[0.15em] text-gray-500">Delivery Slip</p>
                      </div>
                      <div className="shrink-0 border-2 border-black px-3 py-1.5 text-center">
                        <p className="text-[7px] font-bold uppercase tracking-wider">Box</p>
                        <p className="text-[13px] font-black">{boxIndex + 1} / {totalBoxes}</p>
                      </div>
                    </div>

                    <div className="qr-block flex items-center justify-between gap-4 border-b py-2.5">
                      <div className="min-w-0">
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Tracking Number</p>
                        <p className="mt-0.5 break-all text-[12px] font-black">{printShipment.trackingNumber}</p>
                        <p className="mt-1 text-[7px] text-gray-500">Scan QR to track shipment</p>
                        <p className="mt-2 inline-flex border border-black px-2 py-1 text-[8px] font-black uppercase">
                          {getBoxLabel(printShipment, boxIndex)}
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 border-b py-2.5">
                      <div>
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">From / Sender</p>
                        <p className="mt-0.5 text-[10px] font-black">{printShipment.vendor?.companyName || "Vendor"}</p>
                        <p className="mt-0.5 text-[7px] leading-3 text-gray-600">
                          {printShipment.vendor?.location || printShipment.origin || "—"}
                        </p>
                        {printShipment.vendor?.address && (
                          <p className="mt-0.5 text-[7px] leading-3 text-gray-600">{printShipment.vendor.address}</p>
                        )}
                      </div>
                      <div>
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">To / Receiver</p>
                        <p className="mt-0.5 text-[10px] font-black">{printShipment.receiverName}</p>
                        <p className="mt-0.5 text-[8px] font-semibold">{printShipment.receiverPhone}</p>
                        <p className="mt-0.5 line-clamp-3 text-[7px] leading-3 text-gray-600">{printShipment.receiverAddress}</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-3 gap-3 border-b py-2.5">
                      <div>
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Location</p>
                        <p className="mt-0.5 truncate text-[8px] font-bold">
                          {printShipment.locationRate?.location?.name || printShipment.deliveryZone || "—"}
                        </p>
                      </div>
                      <div>
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Delivery Type</p>
                        <p className="mt-0.5 truncate text-[8px] font-bold">
                          {printShipment.locationRate?.deliveryType?.name || "—"}
                        </p>
                      </div>
                      <div className="text-right">
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Payment Mode</p>
                        <p className="mt-0.5 text-[8px] font-black">{printShipment.paymentType}</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3 border-b py-2.5">
                      ...
                      <div>
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Weight</p>
                        <p className="mt-0.5 text-[9px] font-bold">{printShipment.weight} kg</p>
                      </div>
                      <div className="text-right">
                        <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">COD</p>
                        <p className="mt-0.5 text-[10px] font-black">
                    ...
                    <div className="border-b py-2.5">
                      <p className="text-[7px] font-bold uppercase tracking-wider text-gray-500">Delivery Note</p>
                      <p className="mt-0.5 min-h-[20px] line-clamp-2 text-[8px] leading-3">
                        {printShipment.notes || "—"}
                      </p>
                    </div>

                    <div className="flex items-center justify-between gap-3 border-b py-2.5">
                      <span className="text-[7px] font-bold uppercase tracking-wider">Delivery Charge</span>
                      <span className="text-[11px] font-black">{formatCurrency(printShipment.shippingCharge)}</span>
                    </div>

                    <div className="mt-auto pt-2 text-center">
                      <p className="text-[7px] font-bold uppercase tracking-wider">Handle with care</p>
                      <p className="mt-0.5 text-[6px] text-gray-500">{CARGO_COMPANY_NAME} • Thank you</p>
                    </div>
                  </div>
                );
              }
