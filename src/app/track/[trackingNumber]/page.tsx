...
export default function TrackingPage() {
  ...
  const trackingNumber = Array.isArray(
  ...
  if (loading) {
    return (
      <>
        ...
        <div
          className={`${display.variable} ${mono.variable} flex min-h-screen items-center justify-center bg-[#F5F6F8] pt-24`}
        >
  ...
  if (!shipment) {
    return (
      <>
        ...
        <div
          className={`${display.variable} ${mono.variable} flex min-h-screen items-center justify-center bg-[#F5F6F8] px-6 pt-24`}
        >
  ...
  return (
    <>
      ...
      <div
        className={`${display.variable} ${mono.variable} min-h-screen bg-[#F5F6F8] pb-16 pt-24`}
      >
        {/* ======================================================
            TOP BAR
        ====================================================== */}
